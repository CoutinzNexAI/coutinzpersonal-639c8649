...
const reviews: Review[] = [
  ...
  },
  {
    ...
    text: 'Simplesmente WOW! Transformei a fotografia com poucas expectativas e mal vi o resultado a simular a parede de grafitti tive que comprar! Chegou em 4 dias, qualidade perfeita e o meu quarto ficou com outra vida.',
    author: 'Andre',
    location: 'Porto',
    rating: 5,
    product: 'Poster'
