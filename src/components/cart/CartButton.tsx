...
export const CartButton: React.FC<CartButtonProps> = ({
  ...
  return (
    ...
    >
      ...
      {cartCount > 0 && (
        <div className="absolute inset-0 rounded-xl bg-gradient-to-r from-transparent via-ghibli-moss/10 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-700"></div>
      )}
    </Button>
  );
}; 