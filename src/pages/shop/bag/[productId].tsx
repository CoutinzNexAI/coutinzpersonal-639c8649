...
const BagDetailPage: React.FC<BagDetailPageProps> = ({ product: initialProduct }) => {
  ...
  const validatePurchase = () => {
    if (!selectedImageUrl) return 'Escolha uma arte primeiro para personalizar o seu saco!';
    ...
    if (selectedPrintifyVariantId === null) return 'Por favor, selecione o tipo de saco.';
  ...
  const handleAddToCart = async () => {
    ...
    try {
      ...
      CartService.addToCart({
        ...
        productCategory: product!.category || 'bag',
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content={`Personalize o seu ${product.name} com as suas criações AI. Sacos práticos e resistentes com impressões únicas.`} />
      </Head>
                ...
                <CardContent className="relative z-10 p-4 sm:p-6 space-y-3 sm:space-y-4">
                  ...
                  <div className="px-1">
                    <p className="text-sm leading-relaxed font-medium text-ghibli-earth/80">
                      Saco <span className="font-bold text-ghibli-moss">prático e resistente</span>! 
                      Material durável com <span className="font-bold">impressão de alta qualidade</span> que não desbota.
                    </p>
                  </div>
                        ...
                        <div className="flex items-center gap-2 sm:gap-3">
                          ...
                          <SelectValue placeholder="Escolha o tipo">
                            <span className="truncate">
                              {product.variants?.find(v => v.id === selectedPrintifyVariantId)?.title || 'Escolha o tipo'}
                            </span>
                          </SelectValue>
                        </div>
                      </SelectTrigger>
                    ...
                    {isProcessingMockup ? (
                      <div className="w-full py-5 sm:py-6 bg-gradient-to-r from-ghibli-moss/50 to-ghibli-moss-light/50 rounded-xl lg:rounded-2xl text-center">
                        <div className="flex items-center justify-center space-x-2">
                          ...
                          <span className="text-ghibli-moss font-medium text-sm sm:text-base">Criando o seu saco mágico...</span>
                        </div>
                    ...
                    <Button
                      ...
                      {loading ? (
                        <>
                            ...
                            <span className="text-center">Selecione o Tipo</span>
                      ) : (
                        <>
                  ...
                  <div className="grid grid-cols-2 gap-2 sm:gap-3 pt-3 sm:pt-4">
                    <div className="group p-3 sm:p-4 bg-gradient-to-br from-ghibli-cream/40 to-ghibli-cream/20 rounded-lg sm:rounded-xl hover:from-ghibli-cream/60 hover:to-ghibli-cream/30 transition-all duration-300 text-center border border-ghibli-sand/30">
                      ...
                      <span className="text-xs font-bold text-ghibli-earth">Material Resistente</span>
                    </div>
                    ...
                    <div className="group p-3 sm:p-4 bg-gradient-to-br from-ghibli-cream/40 to-ghibli-cream/20 rounded-lg sm:rounded-xl hover:from-ghibli-cream/60 hover:to-ghibli-cream/30 transition-all duration-300 text-center border border-ghibli-sand/30">
                      ...
                      <span className="text-xs font-bold text-ghibli-earth">Impressão Durável</span>
                    </div>
...
// Geração estática dos paths para produtos de saco
