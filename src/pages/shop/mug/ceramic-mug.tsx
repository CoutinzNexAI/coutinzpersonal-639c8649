  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Personalize a sua caneca cerâmica com arte AI única. Disponível em 330ml (€22,50) e 450ml (€27,50). Desconto progressivo a partir de 2 unidades!" />
        ...
        <main className="container mx-auto px-4 py-6 lg:py-8">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid lg:grid-cols-2 gap-6 lg:gap-12">
              {/* COLUNA ESQUERDA: Preview/Mockup */}
              <motion.div
              ...
              >
                ...
                <div className="relative bg-white rounded-2xl shadow-xl border border-ghibli-sand/30 overflow-hidden">
                  <div className="aspect-square relative flex items-center justify-center p-4 sm:p-8">
                  ...
                  >
                    <div className="bg-white/90 backdrop-blur-sm rounded-lg px-3 py-2 border border-ghibli-sand/30">
                      <div className="text-sm text-ghibli-earth/60">
                        <Link href="/" className="hover:text-ghibli-moss transition-colors">
                          🏠 Início
                        </Link>
              ...
              >
                ...
                {/* MOBILE: Card de Preço e Quantidade */}
                <motion.div 
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                ...
                {/* DESKTOP: Informações do Produto */}
                <motion.div 
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                ...
                >
                  <Button
                    ...
                    disabled={!userInfo}
                    className="group relative w-full py-4 sm:py-5 lg:py-6 text-base sm:text-lg lg:text-xl font-bold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden transform hover:scale-[1.02] border-0 bg-gradient-to-br from-ghibli-wood via-ghibli-wood-light to-ghibli-wood hover:from-ghibli-wood-light hover:via-ghibli-wood hover:to-ghibli-wood-light text-white"
                  >
                    {/* Shimmer effect */}
                    ...
                    <span className="relative z-10 flex items-center justify-center gap-2 sm:gap-3">
                      {!userInfo ? (
                        <span className="text-center">Faça Login para Escolher Arte</span>
                      ) : (
                        <>
                          <span className="text-xl sm:text-2xl">🎨</span>
                          <span>Escolher Arte AI</span>
                  ...
                  <Card className="bg-white/80 backdrop-blur-sm border-ghibli-sand/40">
                    <CardContent className="p-4 lg:p-6">
                      ...
                      <div className="mb-6">
                        ...
                        >
                          <SelectTrigger className="w-full h-12 lg:h-14 bg-white/80 backdrop-blur-sm border-2 border-ghibli-sand/40 rounded-xl text-ghibli-earth font-medium hover:border-ghibli-moss/60 focus:border-ghibli-moss transition-all duration-200 shadow-sm hover:shadow-md">
                            <div className="flex items-center gap-2 sm:gap-3">
                              <div className="w-2 h-2 rounded-full bg-ghibli-moss shrink-0"></div>
                              <SelectValue placeholder="Escolha o tamanho">
                                <span className="truncate">
                                  {selectedSize === '330ml' ? '330ml - Tamanho clássico (€22,50)' : '450ml - Tamanho grande (€27,50)'}
                                </span>
                              </SelectValue>
                            </div>
                          </SelectTrigger>
                          <SelectContent className="bg-white text-ghibli-earth border-ghibli-sand max-h-60 shadow-xl">
                            <SelectItem value="330ml" className="hover:bg-ghibli-cream/50">
                              330ml - Tamanho clássico (€22,50)
                            </SelectItem>
                            <SelectItem value="450ml" className="hover:bg-ghibli-cream/50">
                              450ml - Tamanho grande (€27,50)
                            </SelectItem>
                          </SelectContent>
                        </Select>
                      </div>
