...
export const PIC_TUZ_PRINTIFY_PRODUCT_MAP: Record<string, PrintifyProductMapping> = {
  ...
  'ceramic_mug': {
    ...
    supportsManualAdjustment: true, // ✅ ATIVADO: Ajustes verticais (cima/centro/baixo)
    printAreasConfig: [{
  ...
  'poster_horizontal_semi_glossy': {
    ...
    variants: [
      { id: 92369, title: '7" x 5" (Horizontal) / Semi Glossy', placeholderWidth: 2100, placeholderHeight: 1500, isGiftPackaging: false, priceAdjustment: 0.00 },
      { id: 92371, title: '8" x 6" (Horizontal) / Semi Glossy', placeholderWidth: 2400, placeholderHeight: 1800, isGiftPackaging: false, priceAdjustment: 3.00 },
      { id: 92373, title: '10″ x 8″ (Horizontal) / Semi Glossy', placeholderWidth: 3000, placeholderHeight: 2400, isGiftPackaging: false, priceAdjustment: 6.00 },
      { id: 101854, title: '11″ x 9″ (Horizontal) / Semi Glossy', placeholderWidth: 3300, placeholderHeight: 2700, isGiftPackaging: false, priceAdjustment: 9.00 },
      { id: 92375, title: '14″ x 11″ (Horizontal) / Semi Glossy', placeholderWidth: 4200, placeholderHeight: 3300, isGiftPackaging: false, priceAdjustment: 12.00 },
      { id: 101826, title: '17″ x 11″ (Horizontal) / Semi Glossy', placeholderWidth: 5100, placeholderHeight: 3300, isGiftPackaging: false, priceAdjustment: 15.00 },
      { id: 101838, title: '16.5" x 11.7" (Horizontal) / Semi Glossy', placeholderWidth: 4961, placeholderHeight: 3508, isGiftPackaging: false, priceAdjustment: 18.00 },
      { id: 92377, title: '18″ x 12″ (Horizontal) / Semi Glossy', placeholderWidth: 5400, placeholderHeight: 3600, isGiftPackaging: false, priceAdjustment: 21.00 },
      { id: 101830, title: '16″ x 12″ (Horizontal) / Semi Glossy', placeholderWidth: 4800, placeholderHeight: 3600, isGiftPackaging: false, priceAdjustment: 24.00 },
      { id: 92379, title: '20″ x 16″ (Horizontal) / Semi Glossy', placeholderWidth: 6000, placeholderHeight: 4800, isGiftPackaging: false, priceAdjustment: 27.00 },
      { id: 101842, title: '23.4" x 16.5" (Horizontal) / Semi Glossy', placeholderWidth: 7016, placeholderHeight: 4961, isGiftPackaging: false, priceAdjustment: 30.00 },
      { id: 92381, title: '24″ x 18″ (Horizontal) / Semi Glossy', placeholderWidth: 7200, placeholderHeight: 5400, isGiftPackaging: false, priceAdjustment: 33.00 },
      { id: 101834, title: '24″ x 16″ (Horizontal) / Semi Glossy', placeholderWidth: 7200, placeholderHeight: 4800, isGiftPackaging: false, priceAdjustment: 36.00 },
      { id: 92383, title: '30″ x 20″ (Horizontal) / Semi Glossy', placeholderWidth: 9000, placeholderHeight: 6000, isGiftPackaging: false, priceAdjustment: 39.00 },
      { id: 101850, title: '33.1" x 23.4" (Horizontal) / Semi Glossy', placeholderWidth: 9933, placeholderHeight: 7016, isGiftPackaging: false, priceAdjustment: 42.00 },
      { id: 101846, title: '34" x 22" (Horizontal) / Semi Glossy', placeholderWidth: 10200, placeholderHeight: 6600, isGiftPackaging: false, priceAdjustment: 45.00 },
      { id: 92385, title: '32" x 24" (Horizontal) / Semi Glossy', placeholderWidth: 9600, placeholderHeight: 7200, isGiftPackaging: false, priceAdjustment: 48.00 },
      { id: 92387, title: '36" x 24" (Horizontal) / Semi Glossy', placeholderWidth: 10800, placeholderHeight: 7200, isGiftPackaging: false, priceAdjustment: 51.00 },
      { id: 92409, title: '40" x 28" (Horizontal) / Semi Glossy', placeholderWidth: 12000, placeholderHeight: 8400, isGiftPackaging: false, priceAdjustment: 54.00 },
    ],
    printAreasConfig: [{
      position: 'front',
      allowsUserImage: true,
